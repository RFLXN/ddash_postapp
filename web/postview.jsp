...
<%@ page import="postapp.OracleAccess" %>
        ...
        <div class="l-header_nav">
          <ul class="l-header_nav_items">
            ...
            <li class="l-header_nav_item">
              <form id="form1" action="searchresult">
  ...
  <div class="m-roundBox m-roundBox-min-md">
    <main class="l-main" id="main">
        ...
        <div title="topic-upper"> <%-- トピックの上段部 --%>
          <h2 class="m-section_heading m-section_heading-h2"><%=title%></h2><br>
          <h4>作成者 : <%=author%> &nbsp;&nbsp; 作成日 : <%=date%>
          </h4>
          <h4>タグ :
            <c:choose>
              <c:when test="<%=hasTag%>">
            ...
            <c:choose>
              <c:when test="<%=isEdit%>">
                <textarea name="content" cols="70" rows="10" maxlength="3998" required
                          class="m-roundBorder"><%=content%></textarea>
              </c:when>
              <c:otherwise>
